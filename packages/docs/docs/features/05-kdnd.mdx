...
![Drag and Drop Reparenting Demo](../../static/img/ht-kdnd-navigation.gif)
...
![Drag and Drop Reparenting Demo](../../static/img/ht-kdnd-foreign-in.gif)
...
![Drag and Drop Reparenting Demo](../../static/img/ht-kdnd-foreign-out.gif)