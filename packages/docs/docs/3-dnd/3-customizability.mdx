...
control over where users can initiate dragging, you can set [`seperateDragHandle`](/api/core/interface/DragAndDropFeatureConfig#seperateDragHandle)
...
<DemoBox tags={["feature/dnd"]} initialStory="react-drag-and-drop-seperate-drag-handle--seperate-drag-handle" />